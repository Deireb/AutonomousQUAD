...
Inference::Inference(const std::string &onnxModelPath, const cv::Size &modelInputShape, const std::string &, const bool &runWithCuda)
{
...
std::vector<Detection> Inference::runInference(const cv::Mat &input, PreprocInfo* preproc, cv::Mat* preprocImage)
{
